#import "Global.h"
#include "BDMRootListController.h"

UIWindow *settingsView;
UIColor *originalTint;

@implementation BDMRootListController
...
- (void)loadView {
	...
	[UISwitch appearanceWhenContainedIn: self.class, nil].onTintColor = MIA_BLUE;
	[UISegmentedControl appearanceWhenContainedIn: self.class, nil].tintColor = MIA_BLUE;
}

- (void)viewWillAppear:(BOOL)animated {
	settingsView = [[UIApplication sharedApplication] keyWindow];
	originalTint = settingsView.tintColor;
	settingsView.tintColor = MIA_BLUE;
}
...
- (void)testBanner {
    CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFSTR("com.brycedev.mia.testbanner"), nil, nil, YES);
}
